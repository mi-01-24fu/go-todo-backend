...
// Source: internal\service\getlist\verifyget_list.go

// Package getList is a generated GoMock package.
package get_list
...
func (m *MockVerifyGetTODOList) GetTODOList(arg0 getlist.GetTODORequest) (getlist.GetTODOList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTODOList", arg0)
	ret0, _ := ret[0].(getlist.GetTODOList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
